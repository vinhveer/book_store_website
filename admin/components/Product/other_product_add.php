<div class="container-fluid mt-3">
    <h3><a style="color:black;" href="other_product.php"><i class='bx bxs-chevrons-left me-3'></i></a>Thêm Sản Phẩm</h3>
    <hr>
    <div class="mb-3">
    ...
    <form action="components/Product/process.php" method="post" enctype="multipart/form-data">
      <div class="row">
          <div class="mb-3 col-md-3">
            ...
            <input type="text" class="form-control" id="productName" name="other_product_name">
          </div>
          <div class="mb-3 col-md-3">
            <?php
            ...
            <select class="form-select" id="officeType" name="category">
              ...
              <?php
                  while($row_product_categories = sqlsrv_fetch_array($query_product_categories)) {?>
                    <option value="<?php echo $row_product_categories['category_id'] ?>"><?php echo $row_product_categories['category_name'] ?></option>
              <?php } ?>
            </select>
          </div>
          <div class="mb-3 col-md-3">
      ...
      <button type="submit" class="btn btn-primary float-end" name="sbm_add_other">Thêm sản phẩm</button>
    </form>
  </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form action="components/Product/process.php?type=1" method="POST">
          <div class="mb-3">
